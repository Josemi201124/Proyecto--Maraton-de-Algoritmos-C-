//Gloder Rodríguez
// EjercicioC485 - Tema: Asignar memoria dinámicamente para un array (new/delete) (variante)
...
int main(){
    ...
    cin.tie(nullptr);
    cout << "--- EjercicioC485 - Asignar memoria dinámicamente para un array (new/delete) (variante) ---\n";
