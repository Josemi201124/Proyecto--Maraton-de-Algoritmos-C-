//Gloder Rodríguez
// EjercicioC489 - Tema: Reservar memoria para matriz dinámica (2D) y liberar (variante)
...
int main(){
    ...
    cin.tie(nullptr);
    cout << "--- EjercicioC489 - Reservar memoria para matriz dinámica (2D) y liberar (variante) ---\n";
