//Gloder Rodríguez
// EjercicioC487 - Tema: Suma de dos números usando punteros como parámetros (variante)
...
int main(){
    ...
    cin.tie(nullptr);
    cout << "--- EjercicioC487 - Suma de dos números usando punteros como parámetros (variante) ---\n";
