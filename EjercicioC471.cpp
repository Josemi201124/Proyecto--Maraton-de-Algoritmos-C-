//Gloder Rodríguez
// EjercicioC471 - Tema: Ejemplo seguro de reinterpret_cast para punteros binarios
...
int main(){
    ...
    cin.tie(nullptr);
    cout << "--- EjercicioC471 - Ejemplo seguro de reinterpret_cast para punteros binarios ---\n";
